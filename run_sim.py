...
def main():
	...
	config=configparser.SafeConfigParser(defaults={'name': 'archive', 'N':'100', 'e':'0.7',
		...
		'a_min':'1.', 'a_max':'2.', 'ang1_mean':'0', 'ang2_mean':'0', 'ang3_mean':'0', 'ang1':'3.',\
		 'ang2':'3.', 'ang3':'3.', 'keep_bins':'False', 'coll':'line', 'pRun':'0.1', 'pOut':'0.1', 
		'p':'2', 'frac':'nan', 'outDir':'./'}, dict_type=OrderedDict)
